...
import 'introvideo_model.dart';
export 'introvideo_model.dart';
...
class _IntrovideoWidgetState extends State<IntrovideoWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IntrovideoModel());
  }
                  ...
                  children: [
                    const Align(
                      ...
                      child: FlutterFlowVideoPlayer(
                        path: 'assets/videos/Senior_Intro_-_ENG.mp4',
                          ...
                          children: [
                            TextSpan(
                              text: FFLocalizations.of(context).getText(
                                'er5n9jhr' /* Where Healthcare is Centered A... */,
                              ),
