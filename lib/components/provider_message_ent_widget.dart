...
import 'provider_message_ent_model.dart';
export 'provider_message_ent_model.dart';

class ProviderMessageEntWidget extends StatefulWidget {
  const ProviderMessageEntWidget({
    super.key,
    this.providerName,
  });
  ...
  @override
  State<ProviderMessageEntWidget> createState() =>
      _ProviderMessageEntWidgetState();
}

class _ProviderMessageEntWidgetState extends State<ProviderMessageEntWidget> {
  late ProviderMessageEntModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProviderMessageEntModel());
